  ...
  # @examples
  # @seealso \code{\link{seewave::meanspec}}, internaly used to build spectrogram.
...
# wav <- readWave("~/Downloads/586_2_Tettigonia_hispanica_754r2.wav")
# wav_std <- standardiseWave(wav)
#   
# w2 <- autoBandPassFilter(wav_std, bps = .5)
# pdf()
# meanspec(w2, 44100)
# dev.off()
# visualiseSound(w2)
# 
# test <- normalize(wav_std)
# pdf()
# a <- meanspec(test, wl=1024,ovlp = 75, plot=T)
# dev.off()
# ?normalize
